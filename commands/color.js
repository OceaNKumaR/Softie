...
module.exports.run = async (bot, message, args) => {
    ...
    if (message.mentions.members.first()) {
       ...
       if(/(#|0x)([0-9A-F]{6})/i.test(args[0])) {
           ...
           message.channel.send({embed: {color: "RED", description: '<a:noheckno:770923367074627595> Please make sure the argument you specify is a hexidecimal color, if you do not know what a hex color is, please [click here!](https://www.color-hex.com/) Example: #FF0000. If you do not specify an argument, I will return your current role color!'}})
           return
       }
    } else {
