...
module.exports.run = async (bot, message, args) => {
    ...
    .addFields(
        ...
        { name: '<:unban:778589792270024705> - `unban`' , value: '**Unban** a banned user from the guild', inline: true},
        { name: ':wastebasket: - `deletechannel`' , value: '**Delete** a channel', inline: true},
        ...
        { name: ':heavy_plus_sign::adult: - `addrole`' , value: 'Add a role to a user.', inline: true},
        { name: ':boy: - `removerole`' , value: 'Remove a role from a user.', inline: true},
        { name: ':bomb: - `nuke`' , value: '**Clones the current channel** and deletes the old one.', inline: true},
